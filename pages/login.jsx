...
const Login = () => {
    ...
    return (
        <Fragment>
            <Head>
                <title>로그인 - 두들링</title>
                <link rel='main-url' href='https://doodling.kr/login' />
                ...
                <meta property="og:url" content='https://doodling.kr/login' />
                <meta property="og:title" content='로그인 | 두들링'/>
                ...
                <meta property='og:site_name' content='로그인 | 두들링' />

                {/* <!-- Twitter --> */}
                <meta property="twitter:card" content="summary_large_image"/>
                <meta property="twitter:url" content='https://doodling.kr/login'/>
                <meta property="twitter:title" content='로그인 | 두들링'/>
